...
const Home = () => {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What is a digital visiting card (QR vCard)?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "A digital visiting card is an online, shareable profile with your contact details, links, and QR for instant sharing.",
        },
      },
      {
        "@type": "Question",
        name: "Is Cardflare free to use?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Yes, Cardflare offers a free plan. You can upgrade for premium themes, analytics, and advanced features.",
        },
      },
      {
        "@type": "Question",
        name: "How do I share my card?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Share via QR code, WhatsApp, or a direct link. Your contacts can save it instantly.",
        },
      },
    ],
  };
          ...
          <Row className="align-items-center">
            ...
            <Col md={5} className="mb-5 mb-md-0 pe-md-5 ps-md-5 ps-lg-5 ">
              ...
              <p className="fs-5 text-muted mb-4">
                ...
                card. Stand out from the crowd with interactive features and
